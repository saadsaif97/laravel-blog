...
@section('header')
<!-- Header -->
<header class="header text-white h-fullscreen pb-80" data-overlay="9"
   ...
   <div class="container text-center">
      ...
      <div class="row h-100">
         <div class="col-lg-8 mx-auto align-self-center">
            ...
            <p><img class="avatar avatar-sm" src="{{ Gravatar::src('$user->email') }}" alt="..."></p>
...
<script>
   ...
   *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
   ...
   function add_disqus() { // DON'T EDIT BELOW THIS LINE
      var d = document, s = d.createElement('script');
      s.src = 'https://blog-cms-7.disqus.com/embed.js';
